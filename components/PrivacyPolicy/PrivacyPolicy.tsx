    ...
    return (
        ...
        >
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        this Agreement) refers to FIVA E&amp;S SOLUTIONS SL, Calle Sierra
                        Nevada, 22.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to fiva, accessible from{" "}
                        <a href="https://fiva.es/" rel="external nofollow noopener">
                            https://fiva.es/
                        </a>
                    </p>
                </li>
            ...
            <p>
                ...
                Protocol address, browser type, browser version, the
            ...
            <ul>
                <li>By email: contacto@fiva.es</li>
            </ul>
        </div>
    );
};
