...
const EnergyTransition = () => {
    return (
        <>
            <Container className={styles.TransitionSect1} fluid>
                <Row>
                    <Col className={Styles.ServicepymeTitle} xs={{ span: 12 }} md={{ span: 12 }} >
                        <h1>Transición a Energía Renovable</h1>
                    </Col>
                </Row>
            </Container>
            ...
            <Container className={Styles.ServicepymeSect2} fluid>
                <Row>
                    <Col className={Styles.ServicepymeSect2Title} xs={{ span: 12 }} md={{ span: 12 }}>
                        <h2>
                            Servicios de Transición a Energía Renovable
                        </h2>
                    </Col>
                </Row>
                <Row className={Styles.space}>
                    ...
                    <Col xs={{ span: 12 }} md={{ span: 6, offset: 0 }}  >
                        <p>
                            Estamos viviendo la modernización de la manera en la que obtendremos energías durante
                ...
                <Row className={Styles.space}>
                    ...
                    <Col xs={{ span: 12 }} md={{ span: 6, offset: 0 }}  >
                        <p>
                            Las tecnologías renovables han llegado para quedarse y ahora es el momento de dar el
                            paso y fomentar el autoconsumo, aportando cada uno su grano de arena.
                        </p>
                        <br />
                    </Col>
                </Row>
                <Row className={Styles.space}>
                    ...
                    <Col xs={{ span: 12 }} md={{ span: 6, offset: 0 }}  >
                        <p>
                            Tanto si su empresa necesita cubrir emisiones de CO2, cómo si le preocupa la
                            calidad del aire que respiramos, instalar alternativas de autoconsumo aportará un grano de
                            arena en esta carrera por la sostenibilidad ambiental
                        </p>
                    </Col>
                </Row>
                <Row className={Styles.space}>
